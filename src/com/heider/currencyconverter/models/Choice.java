...
public class Choice {
    ...
    public String doConversion(Conversion conversion, int index, int index2, String name) {
        ...
        return(value+"["+possible.get(index)+"] en "+name+ " son " +result+"["+possible.get(index2)+"]");
    }
}
